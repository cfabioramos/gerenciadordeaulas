...
1. Cada aula pertence a uma aula programada: * x 1
2. Cada aluno pode estar matriculado em um ou muitas aulas programadas: * x *
3. Cada aluno pode estar presente em uma ou muitas aulas: * x *
...
BANCO DE DADOS:
Connection String:
postgresql://neondb_owner:npg_SvBapD0Ah6Rw@ep-cold-pine-axkrxua6.c-4.us-east-2.aws.neon.tech/neondb?sslmode=req
...
PASSO 5
Considerando o DER em anexo gere o método Spring Boot consultarAlunosPorProgramaAula na classe ProgramaAulaRepository que consulta os alunos (tabela aluno) matriculados (tabela matricula) conforme o programa de aula (programa_aula) indicado (variável programaAulaId). Incluir um atributo boleano com indicação da presença (tabela presença) do aluno na aula (tabela aula, variável aulaId)